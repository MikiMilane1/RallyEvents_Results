...
add_time()
x = add_time(dt.time(minute=20, second=45), dt.time(minute=21, second=0, microsecond=45),
               dt.time(minute=33, second=45))


print(type(x.isoformat(timespec="milliseconds")))